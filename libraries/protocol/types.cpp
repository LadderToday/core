...
namespace core { namespace protocol {
    ...
    public_key_type::public_key_type( const std::string& base58str )
    {
      ...
      //        to make public_key_type API more similar to address API
       std::string prefix( CORE_ADDRESS_PREFIX );
    ...
    public_key_type::operator std::string() const
    {
       ...
       return CORE_ADDRESS_PREFIX + fc::to_base58( data.data(), data.size() );
    }
...
namespace fc
{
    ...
    {
        vo = core::protocol::public_key_type( var.as_string() );
    }
    ...
    {
       vo = core::protocol::extended_public_key_type( var.as_string() );
    }
    ...
    {
       vo = core::protocol::extended_private_key_type( var.as_string() );
    }
} // fc
