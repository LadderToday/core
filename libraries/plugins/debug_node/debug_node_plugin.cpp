...
)
{
   ...
   core::chain::public_key_type debug_public_key;
   if( debug_key != "" )
   {
   ...
   while( produced < count )
   {
      ...
      core::chain::public_key_type scheduled_key = scheduled_witness.signing_key;
      if( debug_key != "" )
      {
...
CORE_DEFINE_PLUGIN( debug_node, core::plugin::debug_node::debug_node_plugin )
